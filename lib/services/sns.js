...
SNS.prototype.listSubscriptions = function(nextToken){
    ...
    return this.request('/')
        ...
        .send(params)
        .end(function(res){
            res.subscriptions = res.listSubscriptionsResponse.listSubscriptionsResult.subscriptions.member;
            return res;
        });
};
...
SNS.prototype.listSubscriptionsByTopic = function(arn, nextToken){
    ...
    return this.request('/')
        ...
        .send(params)
        .end(function(res){
            res.subscriptions = res.listSubscriptionsByTopicResponse.listSubscriptionsByTopicResult.subscriptions.member;
            return res;
        });
};
