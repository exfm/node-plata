...
Request.prototype.logError = function(message){
    ...
    ['host', 'path', 'method', 'port', 'headers'].map(function(k){
        req[k] = self.opts[k];
    });

    log.error('Error: ' + message +
        '\n\tRaw Response:\n\t\t' + util.inspect(this.response, false, 10, false) +
        '\n\tRequest:\n\t\t' + util.inspect(req, false, 10, false) +
        '\n\tPost Body\n\t\t' + util.inspect(this.body, false, 10, false));
};
...
Request.prototype.retry = function(d){
    var self = this;
